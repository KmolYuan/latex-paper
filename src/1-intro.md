...
```markdown
引用單一的參考 @efd 與 @vf-two 和連續引用 [@vf-two;...]。
```

引用單一的參考 @efd 與 @vf-two 和連續引用 [@vf-two;@ga;@pso;@de;@hertz1882ueber;@rosheim1994robot;@lane1998advanced;@sapietova2016analysis;@essay62109;@gravagne2002phd-thesis]。
